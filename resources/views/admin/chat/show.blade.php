...
@section('content')
    <div class="header">
        <h1 class="title">Chat with {{ $user->name }}</h1>
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.chat.index') : route('client.invoices.index') }}"
            style="color: var(--text-muted); text-decoration: none;">&larr; Back</a>
    </div>
